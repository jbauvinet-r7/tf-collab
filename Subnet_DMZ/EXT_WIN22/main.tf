...
#  Windows 22                                                                                                                                                                                                                                                  
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
resource "aws_instance" "win22_node" {
  ...
  tags = {
    "Name"        = "${var.Tenant} - DMZ - Server - Win22 - ${var.User_Account}"
    "Tenant"      = "${var.Tenant}"
...
#  EIP + Association                                                                                                                                                                                                                                                                    
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
resource "aws_eip_association" "eip_assoc_win22_node" {
  instance_id   = aws_instance.win22_node.id
  allocation_id = aws_eip.win22_node.id
}
resource "aws_eip" "win22_node" {
  domain = "vpc"
}
