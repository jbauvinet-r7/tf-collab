...
f"aws s3 cp s3://{bucketname}/Anonymoose.zip /opt/dummy_data/scandata/Anonymoose/",
f"aws s3 cp s3://{bucketname}/Austin.zip /opt/dummy_data/scandata/Austin/",
f"aws s3 cp s3://{bucketname}/Belfast.zip /opt/dummy_data/scandata/Belfast/",
f"aws s3 cp s3://{bucketname}/Boston.zip /opt/dummy_data/scandata/Boston/",
f"aws s3 cp s3://{bucketname}/Los_Angeles.zip /opt/dummy_data/scandata/Los_Angeles/",
f"aws s3 cp s3://{bucketname}/Reading.zip /opt/dummy_data/scandata/Reading/",
f"aws s3 cp s3://{bucketname}/Tokyo.zip /opt/dummy_data/scandata/Tokyo/",
f"aws s3 cp s3://{bucketname}/Toronto.zip /opt/dummy_data/scandata/Toronto/",
f"aws s3 cp s3://{bucketname}/VulnLab.zip /opt/dummy_data/scandata/VulnLab/",
...
sites = ['Austin','Toronto','Los_Angeles','Tokyo','Reading','Anonymoose','Belfast','VulnLab']
site_id = {}
#Create Sites
