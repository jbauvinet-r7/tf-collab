...
Write-Host "InsightVM Installation in progress"
New-Item -Path "C:\s3-downloads\" -Name "insightvm" -ItemType "directory"
Set-ExecutionPolicy UnRestricted -Force
$command = "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12"
Invoke-Expression $command
Invoke-WebRequest -Uri "https://download2.rapid7.com/download/InsightVM/Rapid7Setup-Windows64.exe" -Outfile C:\s3-downloads\insightvm\Rapid7Setup-Windows64.exe
$arguments = "/i `"C:\s3-downloads\insightvm\Rapid7Setup-Windows64.exe`" /l*v c:\s3-downloads\insightvm\installation.log /quiet"
