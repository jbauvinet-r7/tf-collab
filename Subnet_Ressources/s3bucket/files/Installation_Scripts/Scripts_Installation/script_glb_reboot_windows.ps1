...
$FilePath = "c:\UserDataLog\reboot_done.txt"
#Check if file exists in given path
If (Test-Path -path $FilePath -PathType Leaf) {
    Write-Log -Message "Reboot Already Done"
} Else {
    Write-Log -Message "Reboot Time"
    New-Item -Path "c:\UserDataLog\reboot_done.txt" -ItemType File
    Restart-Computer -Force	
}
Write-Host "Reboot Time Script Completed"