...
if [[ "$Agent_Type" == "ngav" ]]; then
    ...
    wget https://s3.amazonaws.com/com.rapid7.razor.public/endpoint/agent/latest/linux/x86_64/rapid7-insight-agent_4.0.12.14-1_amd64.deb
    ...
    chmod +x rapid7-insight-agent_4.0.12.14-1_amd64.deb
    apt-get install ./rapid7-insight-agent_4.0.12.14-1_amd64.deb
    cd /opt/rapid7/ir_agent/components/insight_agent/4.0.12.14/
