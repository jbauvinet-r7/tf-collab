...
cd /opt/temp/
aws s3 cp s3://$Bucket_Name/Orchestrator-Scripts/r7-orchestrator-installer-ubuntu.sh /opt/temp/
chmod +x /opt/temp/r7-orchestrator-installer-ubuntu.sh
INTERACTIVE=0 ./r7-orchestrator-installer-ubuntu.sh
