...
echo "$timestamp - Collector Simulation"
mkdir /home/ubuntu/Locations
chmod +x /home/ubuntu/Locations/Austin/Austin_simulator.sh
sed -i -e 's/\r$//' /home/ubuntu/Locations/Austin/Austin_simulator.sh
chmod +x /home/ubuntu/Locations/Boston/Boston_simulator.sh
sed -i -e 's/\r$//' /home/ubuntu/Locations/Boston/Boston_simulator.sh
chmod +x /home/ubuntu/Locations/Reading/Reading_simulator.sh
sed -i -e 's/\r$//' /home/ubuntu/Locations/Reading/Reading_simulator.sh
chmod +x /home/ubuntu/Locations/Melbourne/Melbourne_simulator.sh
sed -i -e 's/\r$//' /home/ubuntu/Locations/Melbourne/Melbourne_simulator.sh
chmod +x /home/ubuntu/Locations/Rio/Rio_simulator.sh
sed -i -e 's/\r$//' /home/ubuntu/Locations/Rio/Rio_simulator.sh
chmod +x /home/ubuntu/Locations/SanDiego/SanDiego_simulator.sh
sed -i -e 's/\r$//' /home/ubuntu/Locations/SanDiego/SanDiego_simulator.sh
aws s3 cp s3://$Bucket_Name/Collector_Scripts/launch_simulator.sh /home/ubuntu/Locations/
chmod +x /home/ubuntu/Locations/launch_simulator.sh
(crontab -l ; echo "@reboot /home/ubuntu/Locations/launch_simulator.sh") | crontab 
echo "$timestamp - Collector Simulation Deployed"